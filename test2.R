...
site_url = "https://urlretrieval.pfizer.com/urlretrieval/getcontent?chronicleId=090177e18bb63078&docbase=gdms&showNative=true" # application with user permissions
drive_name = "Documents"
file_src = "penguins_raw.csv"

app <- "4bd12a20-75e7-4b1a-bd53-0f0d04a96ded"
tenant <- "pfizer"
...
ui = fluidPage(
  column(2,
  actionButton("btn1", "SSO Auth", class = "btn btn-success", style = "width: 100%; margin-bottom: 20px;"),
